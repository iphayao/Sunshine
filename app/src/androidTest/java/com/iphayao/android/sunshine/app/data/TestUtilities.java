...
import com.iphayao.android.sunshine.app.utils.PollingCheck;
...
public class TestUtilities extends AndroidTestCase {
    ...
    static ContentValues createWeatherValues(long locationRowId) {
        ...
        weatherValues.put(WeatherContract.WeatherEntry.COLUMN_DEGREE, 1.1);
        weatherValues.put(WeatherContract.WeatherEntry.COLUMN_HUMIDITY, 1.2);
        weatherValues.put(WeatherContract.WeatherEntry.COLUMN_PRESSURE, 1.3);
        weatherValues.put(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP, 75);
        weatherValues.put(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP, 65);
        weatherValues.put(WeatherContract.WeatherEntry.COLUMN_SHORT_DES, "Asteroids");
    ...
    public static class TestContentObserver extends ContentObserver {
        ...
        public void waitingForNotificationOrFail() {
